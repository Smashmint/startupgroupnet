    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <div class="pt-10 pb-12 md:pt-16 md:pb-20">
            ...
            <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h2 class="h2 mb-4">Built exclusively for you</h2>
            ...
            <div class="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
                ...
                <div class="relative flex flex-col items-center">
                    <div class="absolute h-1 border-t border-dashed border-gray-700 hidden md:block" style="width:calc(100% - 32px);left:calc(50% + 48px);top:32px;"></div>
                ...
                <!-- 2nd item -->
                <div class="relative flex flex-col items-center">
                    <div aria-hidden="true" class="absolute h-1 border-t border-dashed border-gray-700 hidden md:block" style="width:calc(100% - 32px);left:calc(50% + 48px);top:32px;"></div>
                    <svg class="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                        <rect class="fill-current text-purple-600" width="64" height="64" rx="32" />
